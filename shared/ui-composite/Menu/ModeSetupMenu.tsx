...
import { useAppNavigate } from '@/shared/infra/client/native/NativeNavigation';
...
const ModeSetupMenu = ({
  ...
  useEffect(() => {
    ...
    // Hydrating persisted settings when the menu opens is the intent here.
  ...
  }, [isOpen, onClose, selectedGameMode, handleStartTraining]);
